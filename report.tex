...
5 & Ensemble (Exp 1--4) & -- &
    Averaging the sigmoid probabilities of all four models reduces variance
    and typically outperforms any individual model \cite{dietterich2000ensemble}.
...
Exp 5: Ensemble         & \textbf{0.9923} & \textbf{0.9948} & \textbf{0.9996} \\
\bottomrule
\end{tabular}
\end{table}
...
Exp 5: Ensemble (sum)   & 41{,}585{,}132 & 10.26 \\
\bottomrule
\end{tabular}
\end{table}
