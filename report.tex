...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/task1_1_volume_slicer.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/task1_2_volume_slicer.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/segmentation_axial_views.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/task1_3_volume_slicer.png}
...
Test  (10\%) & 134     & 388     & 522 \\
\midrule
\textbf{Total} & \textbf{1{,}341} & \textbf{3{,}875} & \textbf{5{,}216} \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{Model complexity: parameters and FLOPs at $224\times224$ input,
         measured using \texttt{thop} \cite{thop2023} on a single forward pass.
         Exp 5 shares the same architecture as Exp 3; frozen weights do not
         affect inference FLOPs.}
\label{tab:flops}
\begin{tabular}{lrr}
\toprule
\textbf{Model} & \textbf{Parameters} & \textbf{FLOPs (GFLOPs)} \\
\midrule
Exp 1: Baseline CNN          & 422{,}401      & 0.75 \\
Exp 2: ResNet50              & 23{,}510{,}081 & 4.13 \\
Exp 3: DenseNet121 (full)    & 6{,}954{,}881  & 2.90 \\
Exp 4: EfficientNet-B3       & 10{,}697{,}769 & 1.02 \\
Exp 5: DenseNet121 (frozen)  & 6{,}954{,}881  & 2.90 \\
\bottomrule
\end{tabular}
\end{table}
